...
namespace ShComp
{
    public static class PathCommandGenerator
    {
    ...
    public struct PathCommand
    {
        ...
        public string ToString(int offsetX, int offsetY)
        {
            switch (Method)
            {
                case PathMethod.M: return "M" + (Param1 + offsetX) + " " + (Param2 + offsetY);
                case PathMethod.V: return "V" + (Param1 + offsetX);
                case PathMethod.H: return "H" + (Param1 + offsetY);
                case PathMethod.z: return "z";
            }
